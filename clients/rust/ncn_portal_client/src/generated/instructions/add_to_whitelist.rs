...
impl AddToWhitelist {
  pub fn instruction(&self, args: AddToWhitelistInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddToWhitelistInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = AddToWhitelist {
          ...
          let args = AddToWhitelistInstructionArgs {
                                                              rate_limiting: self.rate_limiting.clone().expect("rate_limiting is not set"),
                                    };
...
impl<'a, 'b> AddToWhitelistCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn whitelist_entry(&mut self, whitelist_entry: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn whitelisted(&mut self, whitelisted: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = AddToWhitelistInstructionArgs {
                                                              rate_limiting: self.instruction.rate_limiting.clone().expect("rate_limiting is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          whitelisted: self.instruction.whitelisted.expect("whitelisted is not set"),
